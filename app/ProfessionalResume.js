...
import React, { useState } from "react";
import {
  Github, Mail, Linkedin, Code, BookOpen, Trophy, Briefcase, Menu, X, ExternalLink,
  User, Terminal, Star, Calendar,
} from "lucide-react";
import {
...
const ProfessionalResume = () => {
  ...
  const skills = {
    "Frontend Development": [
      ...
      "Material UI", "HyperUi", "NextJs", "ShadeCN"
    ],
    "Backend Development": [
      "Node.js", "Express", "MongoDB", "PostgreSQL", "REST APIs", "GraphQL"
    ],
    "Core Skills": [
      "System Design", "Data Structures", "Algorithms", "Agile", "Team Leadership"
    ]
  };
  ...
  const projects = [
    {
      title: "DevFlow - Coding Community Platform",
      description: "Built a Stack Overflow-inspired platform for developers with modern UI. Features include question posting, answer threading, code formatting, and reputation system.",
      tags: ["Next.js", "TypeScript", "MongoDB", "OAuth", "TailwindCSS"],
      link: "https://github.com/Naval1525"
    },
    {
      title: "Job Portal Application",
      description: "Developed a comprehensive job portal with features like job posting, application tracking, resume parsing, and advanced search filters.",
      tags: ["React", "Node.js", "Express", "MongoDB", "Redux"],
      link: "https://github.com/Naval1525"
    },
    {
      title: "Frontend UI Library",
      description: "Developed a reusable frontend UI component library to accelerate development and maintain consistency across projects.",
      tags: ["React", "Tailwind CSS", "Storybook", "TypeScript"],
      link: "https://github.com/Naval1525"
    },
    {
      title: "Collaborative Workspace",
      description: "Built a collaborative platform for teams to manage tasks, communicate, and share resources effectively.",
      tags: ["Next.js", "Socket.io", "MongoDB", "AWS"],
      link: "https://github.com/Naval1525"
    },
    {
      title: "Online Voting System",
      description: "Implemented a secure online voting system with real-time vote counting and admin control panels.",
      tags: ["Node.js", "React", "PostgreSQL", "JWT", "Docker"],
      link: "https://github.com/Naval1525"
    },
    {
      title: "Social Media Application",
      description: "Developed a social platform with features like posts, likes, comments, and real-time notifications.",
      tags: ["Next.js", "MongoDB", "Clerk", "Socket.io"],
      link: "https://github.com/Naval1525"
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 text-gray-100">
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-gray-800 border-b border-gray-700">
            <div className="px-2 pt-2 pb-3 space-y-1">
              ...
              <a href="#experience" className="block px-3 py-2 hover:bg-gray-700 rounded-md">Experience</a>
      ...
      <section className="pt-32 pb-20">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-400 mb-8">
              Full Stack Developer | 2023 Passout | BTech CSE<br />
              Specialized in MERN Stack with 600+ LeetCode Problems Solved | Knight Badge (Rank: 1891)
            </p>
            <div className="flex justify-center gap-4">
              <Button variant="outline" className="gap-2" onClick={() => window.open("https://github.com/Naval1525", "_blank")}>
                <Github size={20} />GitHub
              </Button>
              {/* <Button variant="outline" className="gap-2" onClick={() => window.open("https://www.linkedin.com/in/navalbihani15/", "_blank")}>
                <Linkedin size={20} />LinkedIn
              </Button> */}
              <Button variant="outline" className="gap-2" onClick={() => window.location.href = "mailto:your-email@example.com"}>
                <Mail size={20} />Email
              </Button>
            </div>
          </div>
      ...
      <section id="about" className="py-20">
        <div className="container mx-auto px-4">
          <Card className="bg-gray-800/50 border-gray-700">
            ...
            <CardContent>
              <p className="text-gray-300 leading-relaxed">
                Full Stack Developer with 2.5 years of hands-on experience in building web applications.
                Specialized in MERN stack development with expertise in cloud architecture and DevOps practices.
                Proven track record of leading technical teams and delivering high-impact projects for enterprise clients.
                Strong foundation in computer science with a BTech in CSE (9.3 CGPA) and extensive problem-solving
                experience with 600+ solved LeetCode problems and Knight badge ranking.
              </p>
            </CardContent>
          </Card>
        </div>
            ...
            {experience.map((role) => (
              <Card key={role.title} className="bg-gray-800/50 border-gray-700">
                <CardHeader>
                  <div className="flex justify-between items-start">
                    <div>
                      <CardTitle className="text-xl text-blue-400">{role.title}</CardTitle>
                      <CardDescription className="text-gray-400">{role.company}</CardDescription>
                    </div>
                    <Badge variant="outline" className="text-blue-400 border-blue-400">
                      <Calendar className="w-4 h-4 mr-1" />{role.period}
                    </Badge>
                  </div>
                </CardHeader>
                <CardContent>
                  <ul className="space-y-2">
                    {role.description.map((item, index) => (
                      <li key={index} className="flex items-start gap-2 text-gray-300">
                        <Star className="w-4 h-4 mt-1 text-blue-500 flex-shrink-0" />{item}
                      </li>
                    ))}
                  </ul>
                </CardContent>
      ...
      <section id="skills" className="py-20">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold mb-12 flex items-center gap-2">
            <Terminal className="text-blue-500" />Technical Expertise
          </h2>
          <div className="grid md:grid-cols-2 gap-6">
            {Object.entries(skills).map(([category, skillList]) => (
              <Card key={category} className="bg-gray-800/50 border-gray-700">
                ...
                <CardContent>
                  <div className="flex flex-wrap gap-2">
                    {skillList.map((skill) => (
                      <Badge key={skill} variant="secondary" className="bg-gray-700 hover:bg-gray-600">
                        {skill}
                      </Badge>
                    ))}
                  </div>
      ...
      <section id="projects" className="py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {projects.map((project) => (
              <Card key={project.title} className="bg-gray-800/50 border-gray-700 hover:border-blue-500/50 transition-colors">
                <CardHeader>
                  <CardTitle className="text-xl text-blue-400 flex items-center justify-between">
                    {project.title}
                    <a href={project.link} target="_blank" rel="noopener noreferrer">
                      <ExternalLink size={20} className="text-gray-400 hover:text-blue-400" />
                    </a>
                  </CardTitle>
                </CardHeader>
                <CardContent>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold mb-12 flex items-center gap-2">
            <Trophy className="text-blue-500" />Key Achievements
          </h2>
          <div className="grid md:grid-cols-3 gap-6">
            <Alert className="bg-gray-800/50 border-gray-700">
              ...
              <AlertTitle>Technical Excellence</AlertTitle>
              <AlertDescription className="text-gray-300">
                Solved 600+ DSA problems on LeetCode, achieved Knight Badge with ranking of 1891
              </AlertDescription>
            </Alert>
            <Alert className="bg-gray-800/50 border-gray-700">
              <Star className="h-4 w-4 text-blue-500" />
              <AlertTitle>Academic Excellence</AlertTitle>
              <AlertDescription className="text-gray-300">
                2023 BTech CSE graduate with 9.3 CGPA
              </AlertDescription>
            </Alert>
